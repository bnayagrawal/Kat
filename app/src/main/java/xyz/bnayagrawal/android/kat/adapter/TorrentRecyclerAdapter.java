...
public class TorrentRecyclerAdapter extends RecyclerView.Adapter<TorrentRecyclerAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<Torrent> mTorrents;

    public TorrentRecyclerAdapter(Context context, ArrayList<Torrent> torrents) {
